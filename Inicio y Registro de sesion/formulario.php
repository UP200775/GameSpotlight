...
=======
                    <img src="../Imagenes/login.png" th:src="@{/img/user.png}"/>
>>>>>>> Stashed changes
                </div>
...
=======
                    <button  class="btn btn-primary" onclick="location.href='../Home/Home.html'" ><i class="fas fa-sign-in-alt" ></i>  Iniciar sesión </button>
>>>>>>> Stashed changes
                </form>
