<header class="header-container p-3 text-bg-dark">
        ...
        <a href="../Home/Home.php" class="nav-link  text-white">
          ...
          <div class="text-end">
            <a href="../Inicio y Registro de sesion/formulario.html">
              <button type="button" onclick="location.href='../Inicio y Registro de sesion/formulario.html'"  class="btn btn-outline-primary me-2">Inicia Sesión</button>
            </a>  
