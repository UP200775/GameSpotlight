            ...
            <div class="row gx-4 gx-lg-5">
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body" >
                            <img src="../Imagenes/Games/re41.jpg" height="100%" width="100%" >
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                          <img src="../Imagenes/Games/re2.jpeg" height="100%" width="100%" >
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                      <div class="card-body">
                        <img src="../Imagenes/Games/re43.jpg" height="100%" width="100%" >
                      </div>
                    </div>
                </div>
            </div>
